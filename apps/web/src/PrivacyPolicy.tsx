export const PrivacyPolicy = () => {
  return (
    <>
      <h1 className="text-3xl text-center mt-12">Privacy Policy for Sudoku</h1>
      <p className="mt-4">
        At Sudoku, accessible from , one of our main priorities is the privacy
        of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by Sudoku and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        communications with Sudoku as well as any of your posts on our blogs or
        forums and your communication with other users of Sudoku.
      </p>
      <p>
      ...
      <p>
        Additionally, in order to improve your online experience at Sudoku, we
      ...
      <div>
        ...
        <li>
          ...
          communications with other members, provide customer support and
          contact you from time to time. The information helps us to develop and
          improve our services, to understand and analyse our performance as
          well as your preferences and performance and to customize and
          personalize our service and enhance your experience (including by
          making Gig suggestions, ranking search results, etc.).
        </li>
        <li>
          ...
          achieve the above objectives and in limited cases, if we detect
          activity that we think poses a risk to the Sudoku marketplace, other
          users, our community, or third parties, automated processes may
          restrict or limit your ability to use Sudoku. If you would like to
        ...
        <li>
          to promote and advertise the Site, our services and the
          Sudokumarketplace. For example, we use the information collected from
          you for the purpose of sending direct marketing messages (as detailed
          below), to show you information that may be of interest to you, to
          organize and facilitate referral programs, contests or other
          promotional activities or events.
        </li>
        <li>
          We use your personal information to send you direct marketing
          communications about our products, services or promotions from
          Sudokuthat may be of interest to you or our related services. This may
          be via email, post, SMS, telephone or targeted online advertisements.
        </li>
        <li></li>
      </div>
      ...
      <h2 className="text-2xl mt-8">Our Advertising Partners</h2>
      <ul>
      ...
      <p>
        ...
        advertisements and links that appear on , which are sent directly to
      ...
      <p>
        Note that has no access to or control over these cookies that are used
        by third-party advertisers.
      </p>
      <h2 className="text-2xl mt-8">Children's Information</h2>
      <p>
        Another part of our priority is adding protection for children while
        using the internet. We encourage parents and guardians to observe,
        participate in, and/or monitor and guide their online activity. does not
      ...
      <p>
        ...
        toSudoku, which may include: (i) Identifiers and personal information,
        ...
        example if you provide audio-based services on Sudoku.
      </p>
      <p>
        Information we collect when you use Sudoku, including (i) Identifiers
        and personal information, such as online identifiers, internet protocol
        (IP) addresses, access device and connection information such as browser
      ...
      <p>
        ...
        withSudoku, including: (i) Identifiers and personal information, such as
      ...
      <h2 className="text-2xl mt-8">GDPR Data Protection Rights</h2>
      <p>
